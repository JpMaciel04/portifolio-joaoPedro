...
import computersModel from "./assets/computers.glb?url";
import inter from "./assets/Inter-Medium.woff";
...
function Leds({ instances }: { instances: Instance }) {
  ...
  useMemo(() => {
    ...
    // three.js scene graph nodes are inherently mutable; swapping the LED
    // sphere's material to an unlit one is the intended way to make it glow
    // regardless of scene lighting/tone mapping.
    // eslint-disable-next-line react-hooks/immutability
    nodes.Sphere.material = material;
  }, [nodes]);
  useFrame((state) => {
